...
namespace iWeibo.WP8.ViewModels
{
    public class MainViewModel:ViewModel
    {
        ...
        public DelegateCommand EnterSerchCommand { get; set; }
            ...
            : base(navigationService, phoneApplicationFacade, new Uri(Constants.MainPageView, UriKind.Relative))
        {
            ...
            EnterSettingsCommand = new DelegateCommand(EnterSettings);
            //EnterSerchCommand = new DelegateCommand(null);
        }
        ...
        {
            this.NavigationService.Navigate(new Uri(Constants.SettingsView, UriKind.Relative));
        }
