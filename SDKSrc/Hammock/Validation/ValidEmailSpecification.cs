...
using TencentWeiboSDK.Hammock.Specifications;

namespace TencentWeiboSDK.Hammock.Validation
{
    public class ValidEmailSpecification : VibooSpecification<string>
    {
