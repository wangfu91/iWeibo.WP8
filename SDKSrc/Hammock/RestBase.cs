...
using System.Linq;
using System.Text;
using TencentWeiboSDK.Hammock.Authentication;
using TencentWeiboSDK.Hammock.Caching;
using TencentWeiboSDK.Hammock.Model;
using TencentWeiboSDK.Hammock.Retries;
using TencentWeiboSDK.Hammock.Serialization;
using TencentWeiboSDK.Hammock.Tasks;
using TencentWeiboSDK.Hammock.Web;
using TencentWeiboSDK.Hammock.Streaming;
...
namespace TencentWeiboSDK.Hammock
{
    ...
    public abstract class RestBase : PropertyChangedBase
    {
        ...
        public bool CopyFieldToParameters { get; set; }
